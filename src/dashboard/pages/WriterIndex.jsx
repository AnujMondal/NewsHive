...
import NewsOverlay from "../../info/NewsOverlay";
...
const WriterIndex = () => {
    ...
    const getData = async () => {
        ...
        setLoading(true);
        try {
            const res = await axios.get(`https://newshive-express-1.onrender.com/newsDataFiltered?page=${page}&id=${localStorage.getItem("name")}`, {
                headers: {
