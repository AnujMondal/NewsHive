        ...
        <div className='w-[250px] h-screen fixed left-0 top-0 bg-white'>
            ...
            <ul className='px-3 flex flex-col gap-y-1 font-medium'>
                ...
                {role === 'admin' ? (
                    ...
                    <>
                        <li>
                            <Link to='/writer/createNews' className='px-3 py-2 hover:shadow-lg hover:shadow-indigo-500/20 w-full rounded-sm flex gap-x-2 justify-start items-center hover:bg-indigo-500 hover:text-white'>
                                <span className='text-xl'><FaPlus /></span>
...
{role === 'admin' ? (
    ...
    <li>
        <Link to='/writer/news' className='px-3 py-2 hover:shadow-lg hover:shadow-indigo-500/20 w-full rounded-sm flex gap-x-2 justify-start items-center hover:bg-indigo-500 hover:text-white'>
            <span className='text-xl'><BiNews /></span>
            <span>My News</span>
        </Link>
    </li>
